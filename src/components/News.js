...
=======
		const url =`https://newsapi.org/v2/top-headlines?country=us&category=${category}&page=${page}&apiKey=73b64103eaa24e84b390add5993d267a`
>>>>>>> c781b4b (final)
...
=======
		const url =`https://newsapi.org/v2/top-headlines?country=us&category=${category}&page=${page+1}&apiKey=73b64103eaa24e84b390add5993d267a`
>>>>>>> c781b4b (final)
		setPage(page + 1);
		let data = await fetch(url);
		let parsedData = await data.json();
